...
public class Between_M_M {
	...
	public Between_M_M(MyHDT hdt, String directoryPath, Integer maxLevenshtein, Boolean fixedLev, Boolean ignoreDate, Boolean ignoreBlock, Boolean formatCSV) {
		...
		String resultsFileName = "between-M-M-maxLev-" + maxLevenshtein + fixed + date + block;
		if(formatCSV == true) {
